...
public class Dashboard_transfer_button_ltc {
	...
	public void user_LANDING_STATUS() throws InterruptedException {
		...
		//s3.status_clickon_LTC_Transfer_Button();
		Reporter.log( "ltc tranfer button is clickable user land on deposit page,test case pass", true ); 
	...
	public void takescreenshot() throws IOException {
		...
		Reporter.log("Passed- Check that functionality of transfer button.(LTC ).",true);
