...
import Payment_gatwway_all_pom.Zipcode_error_message;
import Payment_gatwway_all_pom.purchase_screen_pom3;

public class PAymentGateway_Street_field_blank_7_LTC {
	WebDriver driver;
	@BeforeClass
	...
	@Test
	public void street_error_message() throws InterruptedException {
		Street_field_blank_error_message_display s4=PageFactory.initElements(driver, Street_field_blank_error_message_display.class);
        s4.enterDATA();
        s4.streetfield_error_message();
        s4.continuebutton_status();
	}
	@AfterMethod
	public void screenshot() throws IOException {
		Reporter.log(" Check in street, mandatory field is marked with a red asterisk symbol.",true);
