...
import Payment_gatwway_all_pom.Email_Field_userEnter_interger_spe_symbol;
...
public class PAymentGateway_emailid_field_interger_symbol_12_BTC {
	WebDriver driver;
	@BeforeClass
	...
	public void firstname_error_message() throws InterruptedException {
		 Email_Field_userEnter_interger_spe_symbol s4=PageFactory.initElements(driver, Email_Field_userEnter_interger_spe_symbol.class);
        s4.enterDATA();
        s4.email_field_error_message();
