...
import Payment_gatwway_all_pom.Phone_number_error_message;
import Payment_gatwway_all_pom.Proceed_button_pom1;
import Payment_gatwway_all_pom.purchase_screen_pom3;

public class PAymentGateway_phonenumber_field_blank_9_LTC {
	...
	@Test
	public void phonenumber_error_message() throws InterruptedException {
		Phone_number_error_message s4=PageFactory.initElements(driver, Phone_number_error_message.class);
        s4.enterDATA();
        s4.phonenumber_error_message();
        s4.continuebutton_status();
	}
	@AfterMethod
	public void screenshot() throws IOException {
		Reporter.log("Passed- Check in Phone number, mandatory field is marked with a red asterisk symbol.");
