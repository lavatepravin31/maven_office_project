...
import Payment_gatwway_all_pom.Email_field_blank_error_message_show;
import Payment_gatwway_all_pom.PaymentGateway_Dashboard_pom2;
import Payment_gatwway_all_pom.Proceed_button_pom1;
import Payment_gatwway_all_pom.Street_field_blank_error_message_display;
import Payment_gatwway_all_pom.purchase_screen_pom3;

public class PAymentGateway_emailid_field_blank_8_LTC {
	WebDriver driver;
	@BeforeClass
	...
	@Test
	public void emailid_error_message() throws InterruptedException {
		Email_field_blank_error_message_show s4=PageFactory.initElements(driver, Email_field_blank_error_message_show.class);
        s4.enterDATA();
        s4.Email_error_message();
        s4.continuebutton_status();
	}
	@AfterMethod
	public void screenshot() throws IOException {
		Reporter.log("Passed-  Check in Email id field, mandatory field is marked with a red asterisk symbol..",true);
