...
public class hAmberger_menu_clicking_on_profile_menu {
...
//		  driver.manage().timeouts().implicitlyWait(Duration.ofMillis(5000));
  ...
  @Test
  public void click_on_Profile_Menu() throws InterruptedException {
  ...
  HambergerMenu_profile_Window_pom3 s4=PageFactory.initElements(driver, HambergerMenu_profile_Window_pom3.class);
  
  s4.ClickONProfileButton();
  Thread.sleep(5000);
  s4.LAnding_profilepage();
  s4.profiledata();
  s4.validation();
