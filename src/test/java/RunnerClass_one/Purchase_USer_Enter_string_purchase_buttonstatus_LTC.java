...
public class Purchase_USer_Enter_string_purchase_buttonstatus_LTC {
	WebDriver driver;
	@BeforeClass
	...
	public void takescreenshot() throws IOException {
		//Reporter.log("Passed-Verify that user should not enter String value in amount field then purchase button is enable.(LTC)",true);
