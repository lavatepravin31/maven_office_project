...
public class PAymentGateway_date_of_birth_less_than18_error_message_6_LTC {
	WebDriver driver;
	@BeforeClass
	...
	public void citydropdown_error_message() throws InterruptedException {
		Birth_date_less_than_18year_error_message s4=PageFactory.initElements(driver, Birth_date_less_than_18year_error_message.class);
        s4.enterDATA();
