...
import Payment_gatwway_all_pom.Birth_date_less_than_18year_error_message;
import Payment_gatwway_all_pom.Birth_date_more_than_100_year_error_message;
...
public class PAymentGateway_date_of_birth_More_than_100year_error_message_6_LTC {
	...
	public void citydropdown_error_message() throws InterruptedException {
		Birth_date_more_than_100_year_error_message s4=PageFactory.initElements(driver, Birth_date_more_than_100_year_error_message.class);
        s4.enterDATA();
        s4.birth_date_error_message();
