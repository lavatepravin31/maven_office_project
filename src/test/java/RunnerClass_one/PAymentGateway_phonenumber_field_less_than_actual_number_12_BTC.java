...
import Payment_gatwway_all_pom.Phonenumber_userEnter_string_spe_symbol;
import Payment_gatwway_all_pom.Phonenumber_user_enter_less_than_actual_pom;
import Payment_gatwway_all_pom.Proceed_button_pom1;
import Payment_gatwway_all_pom.purchase_screen_pom3;

public class PAymentGateway_phonenumber_field_less_than_actual_number_12_BTC {
	...
	@Test
	public void lessthan_actual_number() throws InterruptedException {
	Phonenumber_user_enter_less_than_actual_pom s4=PageFactory.initElements(driver, Phonenumber_user_enter_less_than_actual_pom.class);
        s4.enterDATA();
        s4.phonenumber_field_error_message();
