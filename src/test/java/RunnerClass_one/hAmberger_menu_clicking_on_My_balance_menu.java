...
import Hamberger_Window_all_pom.HambergerMenu_profile_Window_pom3;
import Hamberger_Window_all_pom.Hamberger_pom1;
import LiberyFile.BaseClass;

public class hAmberger_menu_clicking_on_My_balance_menu {
...
//		  driver.manage().timeouts().implicitlyWait(Duration.ofMillis(5000));
  ...
  @Test
  public void click_on_myprofile_Menu() throws InterruptedException {
  ...
  HambergerMenu_mybalance_Window_pom4 s4=PageFactory.initElements(driver, HambergerMenu_mybalance_Window_pom4.class);
  
  s4.maybalance_button();
  Thread.sleep(4000);
  s4.avilabalbalance();
  s4.validation();
