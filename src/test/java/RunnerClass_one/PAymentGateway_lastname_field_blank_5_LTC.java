...
public class PAymentGateway_lastname_field_blank_5_LTC {
	...
	@Test
	public void lastname_error_message() throws InterruptedException {
		Lastname_field_blank_error_message_show s4=PageFactory.initElements(driver, Lastname_field_blank_error_message_show.class);
        s4.enterDATA();
	...
	public void screenshot() throws IOException {
		Reporter.log(" Passes- Check in last name mandatory field is marked with a red asterisk symbol.");
