...
import Payment_gatwway_all_pom.state_dropdown_blank_error_message;

public class PAymentGateway_state_dropdown_field_blank_14_BTC {
	...
	public void countrydropdown_error_message() throws InterruptedException {
		state_dropdown_blank_error_message  s4=PageFactory.initElements(driver, state_dropdown_blank_error_message.class);
        s4.enterDATA();
        s4.statedropdown_error_message();
