...
import Payment_gatwway_all_pom.Lastname_field_blank_error_message_show;
...
public class PAymentGateway_Zipcode_field_blank_6_LTC {
	WebDriver driver;
	@BeforeClass
	...
	@Test
	public void Zipcode_error_message() throws InterruptedException {
		Zipcode_error_message s4=PageFactory.initElements(driver, Zipcode_error_message.class);
        s4.enterDATA();
        s4.zipcode_error_message();
        s4.continuebutton_status();
	}
	@AfterMethod
	public void screenshot() throws IOException {
		Reporter.log("Passes- Check in Zipcode, mandatory field is marked with a red asterisk symbol.",true);
