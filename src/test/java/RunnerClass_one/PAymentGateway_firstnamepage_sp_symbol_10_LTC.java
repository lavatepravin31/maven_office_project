...
import Payment_gatwway_all_pom.Firstname_field_enter_sp_symbol;
...
public class PAymentGateway_firstnamepage_sp_symbol_10_LTC {
	WebDriver driver;
	@BeforeClass
	...
	public void firstname_error_message() throws InterruptedException {
		Firstname_field_enter_sp_symbol s4=PageFactory.initElements(driver, Firstname_field_enter_sp_symbol.class);
        s4.enterDATA();
