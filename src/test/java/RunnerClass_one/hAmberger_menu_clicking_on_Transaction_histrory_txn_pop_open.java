...
import Hamberger_Window_all_pom.HambergerMenu_TransactonHistory_Window_pom5;
import Hamberger_Window_all_pom.Hamberger_pom1;
import Hamberger_Window_all_pom.Transaaction_history_popup;
import LiberyFile.BaseClass;

public class hAmberger_menu_clicking_on_Transaction_histrory_txn_pop_open {
...
//		driver=BaseClass.Launchbrowserall("http://demo-rt-cb-qa-alb-1696234791.us-east-1.elb.amazonaws.com/#/account/email-confirmation?token=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJlbWFpbCI6InByYXZpbmxAbnUxMC5jbyIsImlhdCI6MTY2ODE2MTE4MiwiZXhwIjoxNjY4MTgyNzgyfQ.qjQzwOMksrRo8hVQ1akaHqUJG4-G4qoWLn2QE2G9a-w");
//		  driver.manage().timeouts().implicitlyWait(Duration.ofMillis(5000));
  ...
  HambergerMenu_TransactonHistory_Window_pom5 s4=PageFactory.initElements(driver, HambergerMenu_TransactonHistory_Window_pom5.class);
  
  s4.hambergerButton();
  Thread.sleep(4000);
  s4.click_transaction();
  Thread.sleep(4000);
  Transaaction_history_popup s6=PageFactory.initElements(driver, Transaaction_history_popup.class);
  s6.validation_123data();
 Thread.sleep(4000);
  }
