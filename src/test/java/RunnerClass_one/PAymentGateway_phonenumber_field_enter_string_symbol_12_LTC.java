...
public class PAymentGateway_phonenumber_field_enter_string_symbol_12_LTC {
	WebDriver driver;
	@BeforeClass
	...
	public void firstname_error_message() throws InterruptedException {
		Phonenumber_userEnter_string_spe_symbol  s4=PageFactory.initElements(driver, Phonenumber_userEnter_string_spe_symbol.class);
        s4.enterDATA();
