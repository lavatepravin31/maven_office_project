...
public class Purchase_USer_avilable_balance_LTC {
	 ...
	 WebDriver driver;
		...
		public void takescreenshot() throws IOException {
			Reporter.log("Passed-Verify that user should able to see available balance on transfer screen  (Crypto & usd)-(LTC)",true);
