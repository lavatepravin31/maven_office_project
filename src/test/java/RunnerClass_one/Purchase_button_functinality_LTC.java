...
import Purchase_screen_all_pom.Paymentgatway_screen_pom;
import Purchase_screen_all_pom.Proceedbutton_Page_pom1;

public class Purchase_button_functinality_LTC {
	 ...
	 WebDriver driver;
		...
		public void POST_avilable_balance() throws InterruptedException {
			...
			Thread.sleep(2000);
		     s2.clickONPurchaseBUtton();
			Thread.sleep(2000);
			
			
			Paymentgatway_screen_pom s4=PageFactory.initElements (driver,Paymentgatway_screen_pom.class);
			s4.validation_purchase_button();
			
		}
		@AfterMethod
		public void takescreenshot() throws IOException {
			//Reporter.log("Passed-Verify that user should able to see post estimated value .(BTC)",true);
