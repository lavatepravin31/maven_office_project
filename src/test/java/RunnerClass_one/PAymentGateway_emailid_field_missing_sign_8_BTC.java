...
import Payment_gatwway_all_pom.emailid_field_missing_sign_8_pom;
import Payment_gatwway_all_pom.purchase_screen_pom3;

public class PAymentGateway_emailid_field_missing_sign_8_BTC {
	WebDriver driver;
	@BeforeClass
	...
	public void emailid_error_message() throws InterruptedException {
		emailid_field_missing_sign_8_pom s4=PageFactory.initElements(driver, emailid_field_missing_sign_8_pom.class);
        s4.enterDATA();
