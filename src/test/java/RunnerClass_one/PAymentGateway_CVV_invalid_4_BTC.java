...
import Payment_gatwway_all_pom.Cvv_field_blank_error_message_show;
import Payment_gatwway_all_pom.Cvv_field_invalid_cvv_message_show;
...
public class PAymentGateway_CVV_invalid_4_BTC {
	WebDriver driver;
	@BeforeClass
	...
	@Test
	public void CVV_error_message() throws InterruptedException {
		Cvv_field_invalid_cvv_message_show s4=PageFactory.initElements(driver, Cvv_field_invalid_cvv_message_show.class);
        s4.enterDATA();
        s4.CVV_error_message();
