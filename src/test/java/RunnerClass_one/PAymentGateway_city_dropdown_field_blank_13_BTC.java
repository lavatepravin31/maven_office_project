...
import Payment_gatwway_all_pom.city_dropdown_blank_error_message;
import Payment_gatwway_all_pom.purchase_screen_pom3;

public class PAymentGateway_city_dropdown_field_blank_13_BTC {
	WebDriver driver;
	@BeforeClass
	...
	public void citydropdown_error_message() throws InterruptedException {
		city_dropdown_blank_error_message  s4=PageFactory.initElements(driver, city_dropdown_blank_error_message.class);
        s4.enterDATA();
