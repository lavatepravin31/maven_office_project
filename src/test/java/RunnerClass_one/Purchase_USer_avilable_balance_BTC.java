...
public class Purchase_USer_avilable_balance_BTC {
  WebDriver driver;
	@BeforeClass
	...
	public void takescreenshot() throws IOException {
		Reporter.log("Passed-Verify that user should able to see available balance on transfer screen  (Crypto & usd)-(BTC)",true);
