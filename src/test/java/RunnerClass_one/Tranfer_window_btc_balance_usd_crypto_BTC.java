...
import Transfer_Window_all_pom.btc_crypto_usd;

public class Tranfer_window_btc_balance_usd_crypto_BTC {
	WebDriver driver;
	@BeforeClass
	...
	public void btc_crypto_usd() {
		...
		btc_crypto_usd s3=PageFactory.initElements(driver, btc_crypto_usd.class);
		s3.btc_crypto_usd();
	}
	@AfterMethod
