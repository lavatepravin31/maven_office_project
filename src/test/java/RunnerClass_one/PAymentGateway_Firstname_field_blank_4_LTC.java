...
public class PAymentGateway_Firstname_field_blank_4_LTC {
	...
	public void firstname_error_message() throws InterruptedException {
		Firstname_field_blank_error_message_show s4=PageFactory.initElements(driver, Firstname_field_blank_error_message_show.class);
        s4.enterDATA();
	...
	public void screenshot() throws IOException {
		Reporter.log("Passed- Check in First name field , mandatory field is marked with a red asterisk symbol..",true);
