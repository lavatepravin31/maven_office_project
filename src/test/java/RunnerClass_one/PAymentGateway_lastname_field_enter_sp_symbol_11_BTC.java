...
import Payment_gatwway_all_pom.lastname_field_enter_sp_symbol;
import Payment_gatwway_all_pom.purchase_screen_pom3;

public class PAymentGateway_lastname_field_enter_sp_symbol_11_BTC {
	...
	@Test
	public void firstname_error_message_enter_sp_symbol() throws InterruptedException {
		lastname_field_enter_sp_symbol s4=PageFactory.initElements(driver, lastname_field_enter_sp_symbol.class);
        s4.enterDATA();
