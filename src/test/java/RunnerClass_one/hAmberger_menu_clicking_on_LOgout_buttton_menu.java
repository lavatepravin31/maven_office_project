...
public class hAmberger_menu_clicking_on_LOgout_buttton_menu {
...
//		  driver.manage().timeouts().implicitlyWait(Duration.ofMillis(5000));
  ...
  HambergerMenu_LOgoutpage_Window_pom7 s4=PageFactory.initElements(driver, HambergerMenu_LOgoutpage_Window_pom7.class);
  
  s4.logoutbuttonclick();
  Thread.sleep(4000);
  s4.validation();
