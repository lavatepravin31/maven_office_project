...
public class PAymentGateway_CVV_field_blank_3_LTC {
	...
	public void CVV_error_message() throws InterruptedException {
		Cvv_field_blank_error_message_show s4=PageFactory.initElements(driver, Cvv_field_blank_error_message_show.class);
        s4.enterDATA();
