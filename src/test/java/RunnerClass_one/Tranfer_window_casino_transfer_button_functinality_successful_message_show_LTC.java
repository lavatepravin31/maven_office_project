...
public class Tranfer_window_casino_transfer_button_functinality_successful_message_show_LTC {
	...
	public void failedpop() throws InterruptedException, IOException {
		Transfer_sucessful_flow_pom_casino_7 s2=PageFactory.initElements(driver, Transfer_sucessful_flow_pom_casino_7.class);
		s2.ClickON_Dropdown();
		s2.enter_amount();
		...
		//pending -pop up handele transsaction sucessful...pop up ,assret,match 
	}
	@AfterMethod
