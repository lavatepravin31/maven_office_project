...
public class Firstname_field_blank_error_message_show {
...
WebDriver driver;
	...
	public Firstname_field_blank_error_message_show(WebDriver driver) {
		this.driver=driver;
	}
	...
	public void enterDATA() throws InterruptedException {
		...
		Reporter.log("First name field Is Blank",true);
	...
	public void Firstname_error_message() {
       if (firstname_field_errorMessage.isDisplayed()) {
    	   ...
    	   System.out.println("Error message is  :: "+mesg);
			...
			System.out.println("firstname field Error message is showing when its blank " );
				
		}
		else {
			System.out.println("firstname field  Error message is not showing ");
		}
       String expected_result="Enter valid First Name";
       String mesg = firstname_field_errorMessage.getText();
       String actual_result=mesg;
       Assert.assertEquals(expected_result, actual_result, "Error message is not match");
       Reporter.log("Pass- Check in First name filed, mandatory field is marked with a red asterisk symbol.",true);		
	}
