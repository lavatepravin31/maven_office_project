...
public class Birth_date_selecting_valid_continue_button_status_19 {
WebDriver driver;
	...
	public Birth_date_selecting_valid_continue_button_status_19(WebDriver driver) {
		this.driver=driver;
	}
	...
	public void enterDATA() throws InterruptedException {
		...
		Thread.sleep(2000);
		driver.findElement(By.xpath("//button[@aria-label='2000']")).click();
		Thread.sleep(2000);
