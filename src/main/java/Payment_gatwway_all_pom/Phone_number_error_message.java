...
public class Phone_number_error_message {
...
WebDriver driver;
	...
	public Phone_number_error_message(WebDriver driver) {
		this.driver=driver;
	}
	...
	public void enterDATA() throws InterruptedException {
		...
		Reporter.log("Phone number field is Blank ",true);
	...
	public void phonenumber_error_message() {
       if (phonenumber_field_errorMessage.isDisplayed()) {
    	   ...
    	   System.out.println("Error message is  :: "+mesg);
			...
			System.out.println("phonenumber field Error message is showing when its blank " );
				
		}
		else {
			System.out.println("phonenumber field  Error message is not showing ");
		}
       
       String expected_result="Enter valid Phone Number";
       String mesg = phonenumber_field_errorMessage.getText();
       String actual_result=mesg;
       Assert.assertEquals(expected_result, actual_result, "Error message is not match");
       Reporter.log("Pass- Check in Phone number filed, mandatory field is marked with a red asterisk symbol.",true);		
