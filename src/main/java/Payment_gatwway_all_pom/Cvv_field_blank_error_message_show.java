...
public class Cvv_field_blank_error_message_show {
WebDriver driver;
	...
	WebElement CVV_field_errorMessage;
	
	
	public Cvv_field_blank_error_message_show(WebDriver driver) {
		this.driver=driver;
	}
	...
	public void enterDATA() throws InterruptedException {
		...
		Reporter.log("CVV field is Blank",true);
	...
	public void CVV_error_message() {
       if (CVV_field_errorMessage.isDisplayed()) {
    	   String mesg = CVV_field_errorMessage.getText();
    	   System.out.println("Error message is  :: "+mesg);
			
			System.out.println("Error field Error message is showing when its blank " );
				
		}
		else {
			System.out.println("Error field  Error message is not showing ");
		}
       

       String expected_result="Please enter valid CVV";  
       String mesg = CVV_field_errorMessage.getText();
