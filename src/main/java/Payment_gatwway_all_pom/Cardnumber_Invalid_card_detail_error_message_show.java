...
public class Cardnumber_Invalid_card_detail_error_message_show {
WebDriver driver;
	...
	public Cardnumber_Invalid_card_detail_error_message_show(WebDriver driver) {
		this.driver=driver;
	}
	...
	public void enterDATA() throws InterruptedException {
		...
		Reporter.log("Enter invalid Card number ",true);
	...
	public void Cardnumber_error_message() {
       ...
       if (cardnumber_field_errorMessage.isDisplayed()) {
    	   ...
    	   System.out.println("Error message is  :: "+mesg);
			...
			Reporter.log("passed-button is disabled without entering valid Card number",true);	
		}
		else {
			System.out.println("cardnumber field  Error message is not showing ");
			Reporter.log("Failed-button is disabled without entering  valid Card number",true);
		}
       ...
       Reporter.log("Passed-Verify that  entering invalid  card number on card number field its should be show error message.",true);  
