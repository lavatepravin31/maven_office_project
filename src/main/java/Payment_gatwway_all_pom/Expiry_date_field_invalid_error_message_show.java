...
public class Expiry_date_field_invalid_error_message_show {
...
WebDriver driver;
	...
	public Expiry_date_field_invalid_error_message_show(WebDriver driver) {
		this.driver=driver;
	}
	
	public void enterDATA() throws InterruptedException {
		cardnumber.sendKeys("4001919257537193");
		Expirydate.sendKeys("12/21");
	...
	public void continuebutton_status() {
		...
		if (continuebutton.isEnabled()) {
			...
			//Reporter.log("failed- Check that entering invalid expiry date then system show error message.",true);
		}
	}
}
