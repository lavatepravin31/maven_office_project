...
public class Lastname_field_blank_error_message_show {
WebDriver driver;
	...
	public Lastname_field_blank_error_message_show(WebDriver driver) {
		this.driver=driver;
	}
	...
	public void enterDATA() throws InterruptedException {
		...
		Reporter.log("Last name field is blank",true);
		Thread.sleep(2000);
	...
	public void lastname_error_message() {
       if (lastname_field_errorMessage.isDisplayed()) {
    	   ...
    	   System.out.println("Error message is  :: "+mesg);
			...
			System.out.println("Lastname field Error message is showing when its blank " );
				
		}
		else {
			System.out.println("Lastname field  Error message is not showing ");
		}
       String expected_result="Enter valid Last Name";
       String mesg = lastname_field_errorMessage.getText();
       String actual_result=mesg;
       Assert.assertEquals(expected_result, actual_result, "Error message is not match");
       Reporter.log("Pass- Check in last name filed, mandatory field is marked with a red asterisk symbol.",true);		
