...
public class Birth_date_more_than_100_year_error_message {
WebDriver driver;
	...
	public Birth_date_more_than_100_year_error_message(WebDriver driver) {
		this.driver=driver;
	}
	...
	public void enterDATA() throws InterruptedException {
		...
		driver.findElement(By.xpath("//button[@aria-label='Previous 24 years']")).click();
		Thread.sleep(2000);
		driver.findElement(By.xpath("//button[@aria-label='1910']")).click();
		Thread.sleep(2000);
		driver.findElement(By.xpath("//div[text()=' JAN ']")).click();
		Thread.sleep(2000);
		driver.findElement(By.xpath("//div[text()=' 1 ']")).click();
		Reporter.log("Birth date is more than 100 year");
		Thread.sleep(4000);
	}
	...
	public void birth_date_error_message() {
       if (Birthdate_errorMessage.isDisplayed()) {
    	   ...
    	   System.out.println("Error message is  :: "+mesg);
			...
			System.out.println("date of birth field shows Error message  when selecting birth date More than 100 year " );
       ...
       Reporter.log("Pass- date of birth field shows Error message  when selecting birth date More than 100 year  ",true);		
