...
public class Lastname_field_interger {
...
WebDriver driver;
	...
	public Lastname_field_interger(WebDriver driver) {
		this.driver=driver;
	}
	...
	public void enterDATA() throws InterruptedException {
		...
		LAstname.sendKeys("009363");
		Reporter.log("Enter Integer value in last name field",true);
		Thread.sleep(2000);
