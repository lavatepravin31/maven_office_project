...
public class Transfer_sucessful_flow_pom_3rdparty_8 {

	  WebDriver driver ;
		
		@FindBy(xpath="//select[@name='favorite']")
		WebElement Click_on_dropdown_button1;
		...
		public Transfer_sucessful_flow_pom_3rdparty_8(WebDriver driver)
		{
			this.driver=driver;
		}
		...
		public void ClickON_Dropdown() {
			...
			Select s=new Select(Click_on_dropdown_button1);
