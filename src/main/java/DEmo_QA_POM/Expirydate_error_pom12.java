...
public class Expirydate_error_pom12 {
...
WebDriver driver;
	...
	WebElement expirydateroormessage;
	
	
	public Expirydate_error_pom12(WebDriver driver) {
		this.driver=driver;
	}
	
	public void enterDATA() throws InterruptedException {
		cardnumber.sendKeys("4001919257537193");
		Expirydate.sendKeys("15/20");
		CVV.sendKeys("465");
	...
	public void expirydatemessage() {
		String e1 = expirydateroormessage.getText();
		System.out.println("expiry date error message is  :  "+e1);
		
	}
	public void continuebuttonstatus() {
		boolean status = continuebutton.isEnabled();
		System.out.println("staus of click button : "+status);
