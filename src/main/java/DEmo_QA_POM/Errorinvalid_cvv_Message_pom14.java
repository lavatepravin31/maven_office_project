...
public class Errorinvalid_cvv_Message_pom14 {
	...
	WebElement errrormessagecvv;
	
	public Errorinvalid_cvv_Message_pom14(WebDriver driver) {
		this.driver=driver;
	}
	...
	public void errormessage() {
		String e1 = errrormessagecvv.getText();
		System.out.println("error message is :"+e1);
		
	}
	public void continuebuttonstatus() {
		boolean c1 = continuebutton.isDisplayed();
		System.out.println("staus of continue button is :"+c1);
	}
}